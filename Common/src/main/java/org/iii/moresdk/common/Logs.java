...
package org.iii.moresdk.common;
...
public abstract class Logs
{
        ...
        if (null != msg && msg.length() > 0)
        {
            ...
            switch (mnTraceLevel)
            {
                ...
                case Type.TRACE_LEVEL_NORMAL:
                    strLog = "[TRACE] " + " class: " + logInfo.strClassPath + " line: " + logInfo
                            .nLine + " Msg: " + msg;
                    break;
                case Type.TRACE_LEVEL_DETAIL:
                    strLog = "[TRACE] " + "file: " + logInfo.strFile + " class: " + logInfo
                            .strClassPath + " method: " + logInfo.strMethod + " line: " + logInfo
                            .nLine + " Msg: " + msg;
                    break;
                default:
                    return;
            ...
            System.out.printf(logInfo.strClassName, strLog);
        }
    }
    ...
    public static void showError(String msg)
    {
        if (msg.length() > 0)
        {
            ...
            strLog = "[TRACE] " + "file: " + logInfo.strFile + " class: " + logInfo.strClassPath
